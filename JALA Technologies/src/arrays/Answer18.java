...
public class Answer18 
{
	...
	{  
        if (n==0 || n==1) // if there are 0 or no elements in array , no possibility of duplicate so return.
        {  
            return n;  
        }    
        ...
        arr[j++] = arr[n-1];// last element n-1 , is positioned at the last position of array because after that no , duplicate possible.  
